...
- [Google Antigravity CLI (`agy`)](https://antigravity.google) installed and configured
...
```sh
agy plugin install https://github.com/palucdev/agyflow
```

#### Local Installation

Clone the repository and install it from the local directory:
...
You can also enable, disable, or uninstall Agyflow using:

```sh
agy plugin enable agyflow
agy plugin disable agyflow
agy plugin uninstall agyflow
```
...
**Important**: Do not use planning mode with workflows (see [Best Practices](#best-practices) below).
