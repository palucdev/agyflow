...
1. Read `.agyflow/docs/INDEX.md` to discover all available project documentation and standards
...
3. Check `.agyflow/docs/standards/` for relevant coding standards
...
- `.agyflow/docs/standards/backend/authentication.md` - Auth standards
