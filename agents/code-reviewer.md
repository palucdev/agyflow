...
Check `.agyflow/docs/INDEX.md` for project standards. Consider project tech stack and patterns. Some patterns may be intentional — don't be overly strict.
...
3. **Read project context** from `.agyflow/docs/INDEX.md` for standards
