...
Read and follow project standards from `.agyflow/docs/standards/` when creating specifications. Reference applicable standards in the Standards Compliance section.
...
2. **Read project context** from `project_context_paths`:
   - `.agyflow/docs/INDEX.md` — project documentation and standards index
...
[Reference applicable standards from .agyflow/docs/standards/]
