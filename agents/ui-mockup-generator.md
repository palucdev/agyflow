...
**Standards**: Check `.agyflow/docs/INDEX.md` for frontend standards (CSS, components, accessibility, responsive design) to ensure mockups align with project conventions.
