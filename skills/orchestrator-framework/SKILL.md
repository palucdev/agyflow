...
This skill provides **shared reference documentation** for all orchestrator skills in the agyflow plugin. It is NOT an executable skill - orchestrators reference these patterns and implement them for their specific domain.
