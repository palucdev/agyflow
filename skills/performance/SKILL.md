...
📋 **Standards Discovery**: Read `.agyflow/docs/INDEX.md` before creating spec.
...
📋 **Standards Discovery**: Read `.agyflow/docs/INDEX.md` before planning.
...
📋 **Standards Discovery**: Implementation reads `.agyflow/docs/INDEX.md` continuously.
...
```
.agyflow/tasks/performance/YYYY-MM-DD-task-name/
