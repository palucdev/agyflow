...
2. Try prepending `.agyflow/` (relative path)
3. Search `.agyflow/tasks/*/` for folder name match
...
- Resume development: `skill: "development"` with `args: "--resume .agyflow/tasks/development/2025-10-23-fix"`
- Restart from phase: `skill: "development"` with `args: "--resume .agyflow/tasks/development/2025-10-26-auth --from=verify"`
- Fresh attempts: `skill: "migration"` with `args: "--resume .agyflow/tasks/migrations/2025-10-20-redux --reset-attempts"`
...
- `.agyflow/docs/INDEX.md` - Project overview and standards
- `.agyflow/tasks/` - Existing task directories
