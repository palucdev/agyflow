...
2. **INDEX.md Discovery**: The file `.agyflow/docs/INDEX.md` maps topics to standard files. Use it to find standards not listed in the plan.
...
- [x] .agyflow/docs/standards/backend/api.md - Listed in Standards Compliance

**From INDEX.md**:

- [x] .agyflow/docs/standards/global/naming.md - Group topic match

**Discovered During Execution**:

- [x] .agyflow/docs/standards/global/security.md - Step 1.3 (auth-related logic)

### Group 2: [Name]

**From Implementation Plan**:

- [x] .agyflow/docs/standards/frontend/forms.md - Listed in Standards Compliance
```
...
You have access to `.agyflow/docs/INDEX.md` for continuous standards discovery.
...
- .agyflow/docs/standards/backend/api.md

**From INDEX.md** (group topic):

- .agyflow/docs/standards/global/naming.md

**Discovered During Execution**:

- .agyflow/docs/standards/global/error-handling.md (step N.2, error handling logic)
