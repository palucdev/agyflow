...
Located in `.agyflow/docs/project/`
...
Located in `.agyflow/docs/standards/global/`
...
Located in `.agyflow/docs/standards/frontend/`
...
Located in `.agyflow/docs/standards/backend/`
...
Located in `.agyflow/docs/standards/testing/`
...
1. **Project documentation** in `.agyflow/docs/` (highest priority)
...
**The documentation in `.agyflow/docs/` represents team decisions and should be followed unless the user explicitly overrides them.**
