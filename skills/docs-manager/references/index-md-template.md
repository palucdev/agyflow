...
Use this structure when generating or updating `.agyflow/docs/INDEX.md`. Scan the actual `.agyflow/docs/` directory to populate sections dynamically — do not hardcode file lists.
...
Located in `.agyflow/docs/standards/[category]/`
