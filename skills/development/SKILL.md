...
**If argument is a research folder path** (matches `.agyflow/tasks/research/*`):
...
**If argument is a quick-\* task folder path** (matches `.agyflow/tasks/quick-*/`):
...
4. Set `quick_reference` in orchestrator state:
   ...
   task_context:
     quick_reference:
       path: .agyflow/tasks/quick-bugfix/2026-05-28-fix-login-timeout
...
```
.agyflow/tasks/development/YYYY-MM-DD-task-name/
