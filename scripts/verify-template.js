...
function checkStructure(templateObj, targetObj, currentPath = "") {
  let errors = [];
...
function main() {
  ...
  const templatePath = path.join(__dirname2, "../templates", templateName);
  ...
  try {
    ...
    targetYaml = import_yaml.default.parse(fileContent);
  } catch (error) {
  ...
  try {
    ...
    templateYaml = import_yaml.default.parse(templateContent);
  } catch (error) {
