...
agyflow provides five workflow types, each with phases tailored to its needs. All workflows pause between phases for your review and input.
...
All workflows create structured directories in `.agyflow/tasks/`:
...
| **docs-manager**                 | Internal engine for managing `.agyflow/docs/` structure, INDEX.md, and standards files                                                          |
